...
<html class="x-admin-sm">
    <head>
        <meta charset="UTF-8">
        <title>@section('title' ,'填充的文本占位')</title>
        ...
        <!-- <link rel="stylesheet" href="./ad/css/theme5.css"> -->
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="./ad/index.html">X-admin v2.2</a></div>
            <div class="left_open">
            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('客户列表','/admin/user')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>客户列表</cite></a>
                            </li>
                            <li>
